...
function updateAPIStatusBadge() {
    ...
    const hasDeepSeek = !!state.apiKeys.deepseek;
    ...
    if (hasAnthropic && hasDeepSeek) {
        ...
        elements.apiStatusText.textContent = 'APIs Conectadas';
    } else {
...
async function startGenerationPipeline() {
    ...
    const hasKeys = state.apiKeys.anthropic && state.apiKeys.deepseek;
